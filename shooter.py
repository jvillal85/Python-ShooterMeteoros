...
pygame.display.set_caption("shooter - By jvilla")
...
#clase para cargar y dar movimiento a las balas.
...
def show_go_screen():
    ...
    draw_text(screen,"=[METEORO SHOOTER]=",65,WIDTH//2,HEIGHT//4)
    draw_text(screen,"Instrucciones:",27,WIDTH//2,HEIGHT//2)
    draw_text(screen,"SPACEBAR = Disparar",27,WIDTH//2,(HEIGHT//2)+30)
    draw_text(screen,"< = Mover Izquierda",27,WIDTH//2,(HEIGHT//2)+60)
    draw_text(screen,"> = Mover Derecha",27,WIDTH//2,(HEIGHT//2)+90)
...
backgound = pygame.image.load("assets/background.png").convert()
